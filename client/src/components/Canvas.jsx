...
const Canvas = ({draw, height, width, childToParent}) => {  
  ...
  // Game Scene Configuration
    const gameScene = new Image();
      //our map
      //gameScene.src = "https://i.imgur.com/JCiEhIp.png";
      gameScene.src = "https://images.unsplash.com/photo-1556200892-4ef0e6b6887b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Z3JleSUyMGdyYWRpZW50fGVufDB8fDB8fA%3D%3D&w=1000&q=80";
...
function animate() {
    ...
    if (keys.ArrowDown.pressed && lastKeyDown === 'ArrowDown') {
      ...
      //childToParent({x: 0, y: gameSceneLayer.position.y });
    }
      ...
      //childToParent({x: gameSceneLayer.position.x, y:0 });
    }
